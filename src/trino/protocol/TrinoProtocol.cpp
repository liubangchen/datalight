...
{
    j = json::object();
    to_json_key(j, "key", p.key, "JsonSerializableEntry", "K", "key");
    to_json_key(j, "value", p.value, "JsonSerializableEntry", "V", "value");
}

void from_json(const json & j, JsonSerializableEntry & p)
{
    from_json_key(j, "key", p.key, "JsonSerializableEntry", "K", "key");
    from_json_key(j, "value", p.value, "JsonSerializableEntry", "V", "value");
}
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License");
