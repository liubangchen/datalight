...
protocol::NodeState convertNodeState(trino::NodeState nodeState) {
  switch (nodeState) {
    case trino::NodeState::ACTIVE:
      return protocol::NodeState::ACTIVE;
    case trino::NodeState::INACTIVE:
      return protocol::NodeState::INACTIVE;
    case trino::NodeState::SHUTTING_DOWN:
...
void TrinoServer::initializeAsyncCache() {
  auto nodeConfig = NodeConfig::instance();
  auto systemConfig = SystemConfig::instance();
...
std::shared_ptr<velox::exec::TaskListener> TrinoServer::getTaskListiner() {
  return nullptr;
}

std::vector<std::string> TrinoServer::registerConnectors(
...
std::shared_ptr<velox::connector::Connector> TrinoServer::connectorWithCache(
