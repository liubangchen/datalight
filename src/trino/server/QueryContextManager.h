...
class QueryContextCache {
 public:
  using QueryCtxWeakPtr = std::weak_ptr<facebook::velox::core::QueryCtx>;
  ...
  std::shared_ptr<facebook::velox::core::QueryCtx> get(protocol::QueryId queryId) {
  ...
  std::shared_ptr<facebook::velox::core::QueryCtx> insert(
...
class QueryContextManager {
 public:
  ...
  std::shared_ptr<facebook::velox::core::QueryCtx> findOrCreateQueryCtx(
  ...
  void visitAllContexts(std::function<void(
                            ...
                            const facebook::velox::core::QueryCtx*)> visitor) const;
